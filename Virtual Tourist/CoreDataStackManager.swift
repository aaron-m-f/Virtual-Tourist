...
class CoreDataStackManager {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.AaronFarber.Virtual_Tourist" in the application's documents Application Support directory.
    ...
    func getSavedObjects(entityName :String) -> [AnyObject] {
